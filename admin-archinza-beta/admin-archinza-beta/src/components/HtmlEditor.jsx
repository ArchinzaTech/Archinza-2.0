...
const HtmlEditor = ({ height, onEditorChange, ...rest }) => {
  return (
    <Editor
      {...rest}
      init={{
        ...
        toolbar:
          "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | print preview media fullscreen | forecolor backcolor emoticons",
        content_style:
