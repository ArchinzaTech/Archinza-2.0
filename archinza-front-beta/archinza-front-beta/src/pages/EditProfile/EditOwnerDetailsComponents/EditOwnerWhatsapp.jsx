...
const EditOwnerWhatsapp = ({ lightTheme }) => {
  // =============== VARIABLE & STATES  ===========================
    ...
    <>
      <div className="field_wrapper padding_left">
        <div className="row">
          ...
          <div className="col-1 col-sm-1 col-md-1 trash_icon_holder p-0">
            <img src={blackDeleteicon} alt="Trash Icon" />
          </div>
        </div>
...
export default EditOwnerWhatsapp;
