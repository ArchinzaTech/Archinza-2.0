...
const BEditProfile06 = () => {
  ...
  const locationList = sections[6].locationList.map((option) => (
    <RadioButton
      ...
      lightTheme
      label={option}
      labelId={"location_bedit6" + option}
      name="project_location_bedit6"
  ...
  const handleDeleteProjectsMedia = async (
    ...
    let payload;
    if (sectionId === 14) {
      payload = { f_completed_projects_media: filteredMedia };
    } else if (sectionId === 15) {
      payload = { f_project_renders_media: filteredMedia };
    } else if (sectionId === 16) {
      payload = { f_work_in_progress_site_media: filteredMedia };
    } else if (sectionId === 17) {
      payload = { f_other_media: filteredMedia };
    } else if (sectionId === 18) {
      ...
      payload = { f_workspace_category_media: updatedTempWorkSpaceData };
  ...
  const handleWorkspaceCategoryChange = async (option) => {
    const filteredCategoryData =
      BusinessContext?.data?.f_workspace_category_media?.filter(
  ...
  const updateMedia = async (mediaId, visibility, sectionId, mediaType) => {
    ...
    let payload;
    if (sectionId === 14) {
      payload = { f_completed_projects_media: updatedMedia };
    } else if (sectionId === 15) {
      payload = { f_project_renders_media: updatedMedia };
    } else if (sectionId === 16) {
      payload = { f_work_in_progress_site_media: updatedMedia };
    } else if (sectionId === 17) {
      payload = { f_other_media: updatedMedia };
    } else if (sectionId === 18) {
      ...
      payload = { f_workspace_category_media: tempWorkSpaceData };
    }
    ...
    setSections((prevSections) => ({
      ...
      [sectionId]: {
        ...
        tempWorkSpaceData:
          sectionId === 18
            ? payload.f_workspace_category_media
  ...
  const handleUpdateMedia = (data, section) => {
    switch (section) {
      ...
      case "Completed Project Photos/Videos":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          f_completed_projects_media: data,
        });
        break;
      ...
      case "Work In Progress":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          f_work_in_progress_site_media: data,
        });
        break;
      case "other":
        setSections((prevSections) => ({
      ...
      case "workspace":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          f_workspace_category_media: data,
        });
        break;
  ...
  const handleSubmit = async (sectionId) => {
    ...
    switch (sectionId) {
      case 0:
        formData["f_services"] = sections[0].selectedOptions;
      ...
      case 4:
        ...
        break;
      case 6:
        formData["f_project_location"] = sections[6].tempSelectedOption;
        ...
        break;
      case 7:
        formData["f_project_typology"] = sections[7].selectedOptions;
        ...
        break;
      case 8:
        formData["f_design_style"] = sections[8].selectedOptions;
  ...
  useEffect(() => {
    if (GlobalDataContext) {
      const globalData = GlobalDataContext?.business_type_f;
  ...
  useEffect(() => {
    if (BusinessContext?.data) {
      ...
      const {
        ...
        f_documents_media,
        f_firm_connect_data,
        f_completed_projects_media,
        f_project_renders_media,
        f_work_in_progress_site_media,
        f_other_media,
        f_workspace_category_media,
      } = BusinessContext.data;

      updatedSections[0].selectedOptions = f_services || [];
      updatedSections[0].tempSelectedOptions = f_services || [];

      updatedSections[6].selectedOption = f_project_location || "";
      updatedSections[6].tempSelectedOption = f_project_location || "";

      updatedSections[7].selectedOptions = f_project_typology || [];
      updatedSections[7].tempSelectedOptions = f_project_typology || [];

      updatedSections[8].selectedOptions = f_design_style || [];
      updatedSections[8].tempSelectedOptions = f_design_style || [];

      updatedSections[4].websiteLink = f_firm_connect_data.website_link || "";
      updatedSections[4].linkedinLink = f_firm_connect_data.linkedin_link || "";
      updatedSections[4].instagramLink =
        f_firm_connect_data.instagram_handle || "";
      updatedSections[4].behanceLink = f_firm_connect_data.behance_link || "";
      updatedSections[4].other = f_firm_connect_data.other || "";
      updatedSections[4].gstNumber = f_firm_connect_data.gst_number || "";
      updatedSections[4].tempValues = {
        websiteLink: f_firm_connect_data.website_link || "",
        linkedinLink: f_firm_connect_data.linkedin_link || "",
        instagramLink: f_firm_connect_data.instagram_handle || "",
        behanceLink: f_firm_connect_data.behance_link || "",
        other: f_firm_connect_data.other || "",
        gstNumber: f_firm_connect_data.gst_number || "",
      };
      updatedSections[13].documentsMedia = f_documents_media || [];
      updatedSections[14].completedProjectsMedia =
        f_completed_projects_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[15].projectRendersMedia =
        f_project_renders_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[16].workInProgressMedia =
        f_work_in_progress_site_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[17].otherMedia =
        f_other_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      ...
      updatedSections[18].workSpaceData =
        f_workspace_category_media?.filter(
          (it) => it.category === selectedCategory
        ) || [];
      updatedSections[18].tempWorkSpaceData = f_workspace_category_media || [];
          ...
          <div className="firm_project_container">
            ...
            >
              ...
              {Object.keys(sections[0].errors).length > 0 && (
                <p className="error">{sections[0].errors.f_services}</p>
              )}
              {activeQuestion === 0 && (
          ...
          <div className="firm_project_container">
            ...
            >
              ...
              {Object.keys(sections[6].errors).length > 0 && (
                <p className="error">{sections[6].errors.f_project_location}</p>
              )}
              {activeQuestion === 6 && (
                <div className="save_cancel_cta no_space">
            ...
            >
              ...
              {Object.keys(sections[7].errors).length > 0 && (
                <p className="error">{sections[7].errors.f_project_typology}</p>
              )}
              {activeQuestion === 7 && (
                <div className="save_cancel_cta">
            ...
            >
              ...
              {Object.keys(sections[8].errors).length > 0 && (
                <p className="error">{sections[8].errors.f_design_style}</p>
              )}
              {activeQuestion === 8 && (
                <div className="save_cancel_cta">
