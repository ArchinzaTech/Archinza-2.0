...
const BEditProfile03 = () => {
  ...
  const employeeCountList = sections[2].employeesRangeList.map((option) => (
    <RadioButton
      ...
      lightTheme
      label={option}
      labelId={"employee_count_bedit3" + option}
      name="employees_range_bedit1"
  ...
  const projectSizeList = sections[5].globalData.map((option) => (
    <CheckboxButton
      ...
      lightTheme
      label={option}
      labelId={"project_size_bedit3" + option}
  ...
  const projectScopeList = sections[10].globalData.map((option) => (
    <CheckboxButton
      ...
      lightTheme
      label={option}
      labelId={"project_scope_bedit3" + option}
  ...
  const locationList = sections[6].locationList.map((option) => (
    <RadioButton
      ...
      lightTheme
      label={option}
      labelId={"location_bedit3" + option}
      name="project_location_bedit3"
  ...
  const budgetList = sections[9].projectBudgetsList
    ...
    .map((option) => (
      <RadioButton
        ...
        lightTheme
        label={option}
        labelId={"budgetList_bedit3" + option}
        name="budget_list_bedit3"
  ...
  const handleDeleteProjectsMedia = async (
    ...
    let payload;
    if (sectionId === 14) {
      payload = { c_completed_projects_media: filteredMedia };
    } else if (sectionId === 15) {
      payload = { c_project_renders_media: filteredMedia };
    } else if (sectionId === 16) {
      payload = { c_work_in_progress_site_media: filteredMedia };
    } else if (sectionId === 17) {
      payload = { c_other_media: filteredMedia };
    } else if (sectionId === 18) {
      ...
      payload = { c_workspace_category_media: updatedTempWorkSpaceData };
  ...
  const handleWorkspaceCategoryChange = async (option) => {
    const filteredCategoryData =
      BusinessContext?.data?.c_workspace_category_media?.filter(
  ...
  const updateMedia = async (mediaId, visibility, sectionId, mediaType) => {
    ...
    let payload;
    if (sectionId === 14) {
      payload = { c_completed_projects_media: updatedMedia };
    } else if (sectionId === 15) {
      payload = { c_project_renders_media: updatedMedia };
    } else if (sectionId === 16) {
      payload = { c_work_in_progress_site_media: updatedMedia };
    } else if (sectionId === 17) {
      payload = { c_other_media: updatedMedia };
    } else if (sectionId === 18) {
      ...
      const tempWorkSpaceData = sections[18].tempWorkSpaceData.map(
        (tempMedia) => {
          ...
          if (correspondingMedia) {
            return {
              ...tempMedia,
              visibility: correspondingMedia.visibility,
            };
          }
          return tempMedia;
        }
      );
      payload = { c_workspace_category_media: tempWorkSpaceData };
    }
    ...
    setSections((prevSections) => ({
      ...
      [sectionId]: {
        ...
        tempWorkSpaceData:
          sectionId === 18
            ? payload.c_workspace_category_media
  ...
  const validation = (sectionId, formData) => {
    const schemaValidation = {
      0: Joi.object({
        c_services: Joi.array()
          .min(1)
          .required()
          .messages({ "array.min": "Select atleast One Service" }),
      }),
      1: Joi.object({
        c_additional_services: Joi.array()
          .min(1)
          .required()
          .messages({ "array.min": "Select atleast One Service" }),
      }),
      2: Joi.object({
        c_employees_range: Joi.string()
          .required()
          .messages({ "string.empty": "Employee Range is required" }),
      }),
      3: Joi.object({
        c_establishment_year: Joi.string()
          .required()
  ...
  const handleUpdateMedia = (data, section) => {
    switch (section) {
      ...
      case "Completed Project Photos/Videos":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          c_completed_projects_media: data,
        });
        break;
      ...
      case "Work In Progress":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          c_work_in_progress_site_media: data,
        });
        break;
      case "other":
        setSections((prevSections) => ({
      ...
      case "workspace":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          c_workspace_category_media: data,
        });
        break;
  ...
  const handleCurrencyChange = async (sectionId, e) => {
    ...
    if (e.target.value !== "INR") {
      const data = await http.get(
        config.api_url +
          `/business/get-currency?base=INR&target=${e.target.value}&section=${querySection}&business_type=business_type_c`
      );
      if (data) {
        setSections((prevSections) => ({
          ...prevSections,
    ...
    setSections((prevSections) => ({
      ...
      [sectionId]: {
        ...
        tempSelectedCurrency: e.target.value,
        tempSelectedOption: "",
        [sectionType]: GlobalDataContext?.business_type_c[
  ...
  const validateSelectedDate = (date) => {
    if (!date) {
      setSections((prevSections) => ({
        ...
        3: {
          ...prevSections[3],
          errors: { c_establishment_year: "Invalid Date" },
        },
      }));
      return false;
    }
    ...
    if (date?.$y > new Date().getFullYear() || date?.$y < currentYear - 50) {
      setSections((prevSections) => ({
        ...
        3: {
          ...prevSections[3],
          errors: {
            c_establishment_year: "Date must be within the last 50 years",
          },
        },
      }));
      return false;
  ...
  const handleSubmit = async (sectionId) => {
    ...
    switch (sectionId) {
      case 0:
        formData["c_services"] = sections[0].selectedOptions;
        ...
        break;
      case 1:
        formData["c_additional_services"] = sections[1].selectedOptions;
        ...
        break;
      case 2:
        formData["c_employees_range"] = sections[2].tempSelectedOption;
      ...
      case 3:
        ...
        if (!validDate) {
          ...
          formData["c_establishment_year"] = validDate?.toString();
      ...
      case 5:
        ...
        formData["c_project_sizes"] = project_sizes;
        ...
        break;
      case 6:
        formData["c_project_location"] = sections[6].tempSelectedOption;
        ...
        break;
      case 7:
        formData["c_project_typology"] = sections[7].selectedOptions;
        ...
        break;
      case 8:
        formData["c_design_style"] = sections[8].selectedOptions;
      ...
      case 10:
        ...
        formData["c_project_scope"] = options;
      ...
      case 11:
        formData["c_project_mimimal_fee"] = {
  ...
  const handleEditButton = async (sectionId) => {
    ...
    if (sectionId == 9 || sectionId == 11) {
      ...
      if (sections[sectionId].tempSelectedCurrency !== "INR") {
        const data = await http.get(
          config.api_url +
            `/business/get-currency?base=INR&target=${sections[sectionId].tempSelectedCurrency}&section=${querySection}&business_type=business_type_c`
        );
        if (data) {
          setSections((prevSections) => ({
            ...prevSections,
  ...
  useEffect(() => {
    if (GlobalDataContext) {
      const globalData = GlobalDataContext?.business_type_c;
  ...
  useEffect(() => {
    if (BusinessContext?.data) {
      ...
      const {
        c_services,
        c_additional_services,
        c_employees_range,
        c_establishment_year,
        c_project_sizes,
        c_project_location,
        c_project_typology,
        c_design_style,
        c_avg_project_budget,
        c_project_scope,
        c_project_mimimal_fee,
        c_documents_media,
        c_firm_connect_data,
        c_completed_projects_media,
        c_project_renders_media,
        c_work_in_progress_site_media,
        c_other_media,
        c_workspace_category_media,
      } = BusinessContext.data;

      const parsedEstablishmentYear = c_establishment_year
        ? dayjs(`${c_establishment_year}-01-01`)
        : null;

      updatedSections[0].selectedOptions = c_services || [];
      updatedSections[0].tempSelectedOptions = c_services || [];

      updatedSections[1].selectedOptions = c_additional_services || [];
      updatedSections[1].tempSelectedOptions = c_additional_services || [];

      updatedSections[2].selectedOption = c_employees_range || "";
      updatedSections[2].tempSelectedOption = c_employees_range || "";

      updatedSections[3].selectedOption = parsedEstablishmentYear;
      updatedSections[3].tempSelectedOption = parsedEstablishmentYear;

      updatedSections[5].selectedOptions = c_project_sizes || [];
      updatedSections[5].tempSelectedOptions = c_project_sizes || [];
      ...
      updatedSections[6].selectedOption = c_project_location || "";
      updatedSections[6].tempSelectedOption = c_project_location || "";

      updatedSections[7].selectedOptions = c_project_typology || [];
      updatedSections[7].tempSelectedOptions = c_project_typology || [];

      updatedSections[8].selectedOptions = c_design_style || [];
      updatedSections[8].tempSelectedOptions = c_design_style || [];

      if (c_avg_project_budget) {
        updatedSections[9].selectedOption = c_avg_project_budget.budget || "";
        updatedSections[9].tempSelectedOption =
          c_avg_project_budget.budget || "";
        updatedSections[9].selectedCurrency =
          c_avg_project_budget.currency || "";
        updatedSections[9].tempSelectedCurrency =
          c_avg_project_budget.currency || "";
      }

      updatedSections[10].selectedOptions = c_project_scope || [];
      updatedSections[10].tempSelectedOptions = c_project_scope || [];
      // if (sections[10].globalData?.length) {
      //   updatedSections[10].allSelected =
      //     sections[10].globalData.slice(1).length === project_scope.length;
      // }
      if (c_project_mimimal_fee) {
        updatedSections[11].selectedOption = c_project_mimimal_fee.fee || "";
        updatedSections[11].tempSelectedOption =
          c_project_mimimal_fee.fee || "";
        updatedSections[11].selectedCurrency =
          c_project_mimimal_fee.currency || "";
        updatedSections[11].tempSelectedCurrency =
          c_project_mimimal_fee.currency || "";
      }

      updatedSections[4].websiteLink = c_firm_connect_data.website_link || "";
      updatedSections[4].linkedinLink = c_firm_connect_data.linkedin_link || "";
      updatedSections[4].instagramLink =
        c_firm_connect_data.instagram_handle || "";
      updatedSections[4].behanceLink = c_firm_connect_data.behance_link || "";
      updatedSections[4].other = c_firm_connect_data.other || "";
      updatedSections[4].gstNumber = c_firm_connect_data.gst_number || "";
      updatedSections[4].tempValues = {
        websiteLink: c_firm_connect_data.website_link || "",
        linkedinLink: c_firm_connect_data.linkedin_link || "",
        instagramLink: c_firm_connect_data.instagram_handle || "",
        behanceLink: c_firm_connect_data.behance_link || "",
        other: c_firm_connect_data.other || "",
        gstNumber: c_firm_connect_data.gst_number || "",
      };
      updatedSections[13].documentsMedia = c_documents_media || [];
      updatedSections[14].completedProjectsMedia =
        c_completed_projects_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[15].projectRendersMedia =
        c_project_renders_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[16].workInProgressMedia =
        c_work_in_progress_site_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[17].otherMedia =
        c_other_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      ...
      updatedSections[18].workSpaceData =
        c_workspace_category_media?.filter(
          (it) => it.category === selectedCategory
        ) || [];
      updatedSections[18].tempWorkSpaceData = c_workspace_category_media || [];
          ...
          <div className="firm_project_container">
            ...
            >
              ...
              {Object.keys(sections[0].errors).length > 0 && (
                <p className="error">{sections[0].errors.c_services}</p>
              )}
              {activeQuestion === 0 && (
            ...
            >
              ...
              {Object.keys(sections[1].errors).length > 0 && (
                <p className="error">
                  {sections[1].errors.c_additional_services}
                </p>
              )}
              {activeQuestion === 1 && (
            ...
            >
              ...
              {Object.keys(sections[2].errors).length > 0 && (
                <p className="error">{sections[2].errors.c_employees_range}</p>
              )}
              {activeQuestion === 2 && (
                <div className="save_cancel_cta no_space">
              ...
              <div className="radio">
                {activeQuestion !== 3 ? (
                  ...
                  <div className="year_picker_wrapper">
                    ...
                    />
                    <p className="error">
                      {sections[3].errors.c_establishment_year}
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="firm_project_container">
            ...
            >
              ...
              {Object.keys(sections[5].errors).length > 0 && (
                <p className="error">{sections[5].errors.c_project_sizes}</p>
              )}
              {activeQuestion === 5 && (
                <div className="save_cancel_cta no_space">
            ...
            >
              ...
              {Object.keys(sections[6].errors).length > 0 && (
                <p className="error">{sections[6].errors.c_project_location}</p>
              )}
              {activeQuestion === 6 && (
                <div className="save_cancel_cta no_space">
            ...
            >
              ...
              {Object.keys(sections[7].errors).length > 0 && (
                <p className="error">{sections[7].errors.c_project_typology}</p>
              )}
              {activeQuestion === 7 && (
                <div className="save_cancel_cta">
            ...
            >
              ...
              {Object.keys(sections[8].errors).length > 0 && (
                <p className="error">{sections[8].errors.c_design_style}</p>
              )}
              {activeQuestion === 8 && (
                <div className="save_cancel_cta">
            ...
            >
              ...
              {Object.keys(sections[9].errors).length > 0 && (
                <p className="error">
                  {sections[9].errors.c_avg_project_budget}
                </p>
              )}
              {activeQuestion === 9 && (
                <div className="save_cancel_cta">
            ...
            >
              ...
              {Object.keys(sections[10].errors).length > 0 && (
                <p className="error">{sections[10].errors.c_project_scope}</p>
              )}
              {activeQuestion === 10 && (
                <div className="save_cancel_cta">
