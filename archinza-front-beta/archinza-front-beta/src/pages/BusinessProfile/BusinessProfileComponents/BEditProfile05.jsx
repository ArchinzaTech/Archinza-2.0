...
const BEditProfile05 = () => {
  ...
  const locationList = sections[6].locationList.map((option) => (
    <RadioButton
      ...
      lightTheme
      label={option}
      labelId={"location_bedit5" + option}
      name="project_location_bedit5"
  ...
  const handleDeleteProjectsMedia = async (
    ...
    let payload;
    if (sectionId === 14) {
      payload = { e_completed_projects_media: filteredMedia };
    } else if (sectionId === 15) {
      payload = { e_project_renders_media: filteredMedia };
    } else if (sectionId === 16) {
      payload = { e_work_in_progress_site_media: filteredMedia };
    } else if (sectionId === 17) {
      payload = { e_other_media: filteredMedia };
    } else if (sectionId === 18) {
      ...
      payload = { e_workspace_category_media: updatedTempWorkSpaceData };
  ...
  const handleWorkspaceCategoryChange = async (option) => {
    const filteredCategoryData =
      BusinessContext?.data?.e_workspace_category_media?.filter(
  ...
  const updateMedia = async (mediaId, visibility, sectionId, mediaType) => {
    ...
    let payload;
    if (sectionId === 14) {
      payload = { e_completed_projects_media: updatedMedia };
    } else if (sectionId === 15) {
      payload = { e_project_renders_media: updatedMedia };
    } else if (sectionId === 16) {
      payload = { e_work_in_progress_site_media: updatedMedia };
    } else if (sectionId === 17) {
      payload = { e_other_media: updatedMedia };
    } else if (sectionId === 18) {
      ...
      payload = { e_workspace_category_media: tempWorkSpaceData };
    }
    ...
    setSections((prevSections) => ({
      ...
      [sectionId]: {
        ...
        tempWorkSpaceData:
          sectionId === 18
            ? payload.e_workspace_category_media
  ...
  const validation = (sectionId, formData) => {
    const schemaValidation = {
      0: Joi.object({
        e_product_categories: Joi.array()
          .min(1)
          .required()
          .messages({ "array.min": "Select atleast One Service" }),
      }),
      1: Joi.object({
        e_additional_services: Joi.array()
          .min(1)
          .required()
          .messages({ "array.min": "Select atleast One Service" }),
      }),
  ...
  const handleUpdateMedia = (data, section) => {
    switch (section) {
      ...
      case "Completed Project Photos/Videos":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          e_completed_projects_media: data,
        });
        break;
      ...
      case "Work In Progress":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          e_work_in_progress_site_media: data,
        });
        break;
      case "other":
        setSections((prevSections) => ({
      ...
      case "workspace":
        ...
        BusinessContext.update({
          ...BusinessContext.data,
          e_workspace_category_media: data,
        });
        break;
  ...
  const validateSelectedDate = (date) => {
    if (!date) {
      setSections((prevSections) => ({
        ...
        3: {
          ...prevSections[3],
          errors: { establishment_year: "Invalid Date" },
        },
      }));
      return false;
    }
    ...
    if (date?.$y > new Date().getFullYear() || date?.$y < currentYear - 50) {
      setSections((prevSections) => ({
        ...
        3: {
          ...prevSections[3],
          errors: {
            establishment_year: "Date must be within the last 50 years",
          },
        },
      }));
      return false;
  ...
  const handleSubmit = async (sectionId) => {
    ...
    switch (sectionId) {
      case 0:
        formData["e_product_categories"] = sections[0].selectedOptions;
        ...
        break;
      case 1:
        formData["e_additional_services"] = sections[1].selectedOptions;
      ...
      case 5:
        ...
        formData["e_project_sizes"] = project_sizes;
        ...
        break;
      case 6:
        formData["e_project_location"] = sections[6].tempSelectedOption;
        ...
        break;
      case 7:
        formData["e_project_typology"] = sections[7].selectedOptions;
        ...
        break;
      case 8:
        formData["e_design_style"] = sections[8].selectedOptions;
      ...
      case 10:
        ...
        formData["e_project_scope"] = options;
  ...
  useEffect(() => {
    if (GlobalDataContext) {
      const globalData = GlobalDataContext?.business_type_e;
  ...
  useEffect(() => {
    if (BusinessContext?.data) {
      ...
      const {
        ...
        e_additional_services,
        e_project_location,
        e_project_typology,
        e_design_style,
        e_documents_media,
        e_firm_connect_data,
        e_completed_projects_media,
        e_project_renders_media,
        e_work_in_progress_site_media,
        e_other_media,
        e_workspace_category_media,
      } = BusinessContext.data;

      updatedSections[0].selectedOptions = e_product_categories || [];
      updatedSections[0].tempSelectedOptions = e_product_categories || [];

      updatedSections[1].selectedOptions = e_additional_services || [];
      updatedSections[1].tempSelectedOptions = e_additional_services || [];

      updatedSections[6].selectedOption = e_project_location || "";
      updatedSections[6].tempSelectedOption = e_project_location || "";

      updatedSections[7].selectedOptions = e_project_typology || [];
      updatedSections[7].tempSelectedOptions = e_project_typology || [];

      updatedSections[8].selectedOptions = e_design_style || [];
      updatedSections[8].tempSelectedOptions = e_design_style || [];

      updatedSections[4].websiteLink = e_firm_connect_data.website_link || "";
      updatedSections[4].linkedinLink = e_firm_connect_data.linkedin_link || "";
      updatedSections[4].instagramLink =
        e_firm_connect_data.instagram_handle || "";
      updatedSections[4].behanceLink = e_firm_connect_data.behance_link || "";
      updatedSections[4].other = e_firm_connect_data.other || "";
      updatedSections[4].gstNumber = e_firm_connect_data.gst_number || "";
      updatedSections[4].tempValues = {
        websiteLink: e_firm_connect_data.website_link || "",
        linkedinLink: e_firm_connect_data.linkedin_link || "",
        instagramLink: e_firm_connect_data.instagram_handle || "",
        behanceLink: e_firm_connect_data.behance_link || "",
        other: e_firm_connect_data.other || "",
        gstNumber: e_firm_connect_data.gst_number || "",
      };
      updatedSections[13].documentsMedia = e_documents_media || [];
      updatedSections[14].completedProjectsMedia =
        e_completed_projects_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[15].projectRendersMedia =
        e_project_renders_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[16].workInProgressMedia =
        e_work_in_progress_site_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      updatedSections[17].otherMedia =
        e_other_media?.map((media) => ({
          ...media,
          visibility: media.visibility || false,
        })) || [];
      ...
      updatedSections[18].workSpaceData =
        e_workspace_category_media?.filter(
          (it) => it.category === selectedCategory
        ) || [];
      updatedSections[18].tempWorkSpaceData = e_workspace_category_media || [];
      setSections(updatedSections);
    }
  }, [BusinessContext?.data]);
          ...
          <div className="firm_project_container">
            ...
            >
              ...
              {Object.keys(sections[0].errors).length > 0 && (
                <p className="error">
                  {sections[0].errors.e_product_categories}
                </p>
              )}
              {activeQuestion === 0 && (
            ...
            >
              ...
              {Object.keys(sections[1].errors).length > 0 && (
                <p className="error">
                  {sections[1].errors.e_additional_services}
                </p>
              )}
              {activeQuestion === 1 && (
          ...
          <div className="firm_project_container">
            ...
            >
              ...
              {Object.keys(sections[6].errors).length > 0 && (
                <p className="error">{sections[6].errors.e_project_location}</p>
              )}
              {activeQuestion === 6 && (
                <div className="save_cancel_cta no_space">
            ...
            >
              ...
              {Object.keys(sections[7].errors).length > 0 && (
                <p className="error">{sections[7].errors.e_project_typology}</p>
              )}
              {activeQuestion === 7 && (
                <div className="save_cancel_cta">
            ...
            >
              ...
              {Object.keys(sections[8].errors).length > 0 && (
                <p className="error">{sections[8].errors.e_design_style}</p>
              )}
              {activeQuestion === 8 && (
                <div className="save_cancel_cta">
