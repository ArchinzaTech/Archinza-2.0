...
const FCStep12LT = ({
  ...
  const handleFileUpload = (uploadedFileData, stateType) => {
    ...
    if (state == "removed") {
      ...
      BusinessContext.update({
        ...
        c_documents_media: [...data, ...uploadedFileData],
      });
    } else {
      ...
      BusinessContext.update({
        ...BusinessContext.data,
        c_documents_media: [...media, ...uploadedFileData],
      });
    }
  };
  ...
  useEffect(() => {
    ...
    setMedia(BusinessContext?.data?.c_documents_media);
  }, [currentStep]);
      ...
      <div className={`${style.steps} ${style.fastep12}`}>
        ...
        <div className={style.customdUpload_wrapper}>
          <BusinessFileUpload
            ...
            documentMediaType={"c_documents_media"}
          />
