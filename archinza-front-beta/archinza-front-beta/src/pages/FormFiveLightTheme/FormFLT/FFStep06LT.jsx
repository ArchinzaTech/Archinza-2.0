...
const FFStep06LT = ({
  ...
  const handleFileUpload = (uploadedFileData, stateType) => {
    ...
    if (state == "removed") {
      ...
      BusinessContext.update({
        ...
        f_documents_media: [...data, ...uploadedFileData],
      });
    } else {
      ...
      BusinessContext.update({
        ...BusinessContext.data,
        f_documents_media: [...media, ...uploadedFileData],
      });
    }
  };
  ...
  useEffect(() => {
    ...
    setMedia(BusinessContext?.data?.f_documents_media);
  }, [currentStep]);

  useEffect(() => {
    if (isActive) {
      progressStatus((8 / 8) * 100);
    }
  }, [isActive]);
  return (
    <>
      ...
      <div className={`${style.steps} ${style.fastep12}`}>
        ...
        <div className={style.customdUpload_wrapper}>
          <BusinessFileUpload
            ...
            documentMediaType={"f_documents_media"}
          />
