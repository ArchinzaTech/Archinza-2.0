...
const FGStep04LT = ({
  ...
  const handleFileUpload = (uploadedFileData, stateType) => {
    ...
    if (state == "removed") {
      ...
      BusinessContext.update({
        ...
        g_documents_media: [...data, ...uploadedFileData],
      });
    } else {
      ...
      BusinessContext.update({
        ...BusinessContext.data,
        g_documents_media: [...media, ...uploadedFileData],
      });
    }
  };
  ...
  useEffect(() => {
    ...
    setMedia(BusinessContext?.data?.g_documents_media);
  }, [currentStep]);
      ...
      <div className={`${style.steps} ${style.fastep12}`}>
        ...
        <div className={style.customdUpload_wrapper}>
          <BusinessFileUpload
            ...
            documentMediaType={"g_documents_media"}
          />
