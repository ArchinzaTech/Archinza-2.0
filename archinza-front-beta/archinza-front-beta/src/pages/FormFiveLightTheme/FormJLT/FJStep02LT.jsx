...
const FJStep02LT = ({
  ...
  const employeeCountList = employees.map((option) => (
    <React.Fragment key={option}>
      <RadioButton
        lightTheme
        label={option}
        labelId={option + "formJ"}
        name="employeeCountFormJ"
        checked={values.j_employees_range === option}
  ...
  useEffect(() => {
    setValues({
      j_employees_range: BusinessAccountContext?.data?.j_employees_range,
    });
  }, [currentStep]);
  ...
  return (
    <>
      <div className={style.text_container}>
        ...
        <div id="j_employees_range_error">
          {formError.j_employees_range && (
