...
import { congratulationsURL } from "../../../components/helpers/constant-words";
...
const RegisterOTP = () => {
  ...
  const handleotpverify = async (e) => {
    const data = await http.post(base_url + "/personal/signup/otp-verify", {
      ...values,
      otp: otpVal,
      // status: "registered",
    });
    ...
    if (data) {
      ...
      auth.login(token);
      navigate(congratulationsURL, { replace: true });
      window.scrollTo(0, 0);
    }
  };
      ...
      <section className="otp_sec1">
        <div className="my_container">
          <div className="text_container">
            ...
            <h1 className="title">Verify your OTP sent via SMS</h1>
