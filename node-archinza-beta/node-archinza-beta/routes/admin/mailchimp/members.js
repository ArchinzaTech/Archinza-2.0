...
router.post(
  "/personal/sync",
  asyncHandler(async (req, res) => {
    const audienceId = req.body.audience;
...
//     res.send(sendResponse(members, `${ModuleName} Synced Successfullly`));
// return;
    ...
    try {
      ...
      res.send(sendResponse(response, `${ModuleName} Synced Successfullly`));
    } catch (error) {
